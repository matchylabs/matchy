...
/// Perfect hash set of PSL suffixes generated at build time
/// Generated by build.rs from src/data/public_suffix_list.dat
/// Uses phf (perfect hash function) for zero-overhead lookups
include!(concat!(env!("OUT_DIR"), "/psl_phf.rs"));
